...
public interface ViewMapper {
    ...
    @Update({
            ...
            "`leftSql` = #{leftSql,jdbcType=LONGVARCHAR},",
            "`rightSql` = #{rightSql,jdbcType=LONGVARCHAR},",
