...
import dq.dto.projectDto.UserMaxProjectPermission;
import dq.dto.roleDto.RoleBaseInfo;
import dq.dto.roleDto.RoleWithProjectPermission;
import dq.model.RelRoleProject;
...
public interface RelRoleProjectMapper {
    ...
    @Update({
            ...
            "rule_permission = #{rulePermission,jdbcType=SMALLINT},",
    ...
    @Select({
            ...
            "       rrp.rule_permission     as 'permission.rulePermission',",
