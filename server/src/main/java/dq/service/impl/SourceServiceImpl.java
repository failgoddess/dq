...
import dq.core.model.DataUploadEntity;
...
import dq.service.SourceService;
...
public class SourceServiceImpl implements SourceService {
    ...
    public boolean reconnect(Long id, DbBaseInfo dbBaseInfo, User user) throws NotFoundException, UnAuthorizedExecption, ServerException {
        ...
        if (redisUtils.isRedisEnable()) {
            ...
            redisUtils.convertAndSend(dq_TOPIC_CHANNEL, new RedisMessageEntity(SourceMessageHandler.class, id, flag));
