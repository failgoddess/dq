...
public class Constants extends Consts {
     ...
     * organization
     */
    public static final String INVITE_ORG_MEMBER_MAIL_SUBJECT = "[dq] %s has invited you to join the %s organization";
    ...
    public static final String NO_AUTH_PERMISSION = "@dq_DATA_ACCESS_DENIED@";

    public static final String dq_TOPIC_CHANNEL = "dq_TOPIC_CHANNEL";
