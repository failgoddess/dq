...
DROP TABLE IF EXISTS `dq_statistic_visitor_operation`;
CREATE TABLE `dq_statistic_visitor_operation` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
...
DROP TABLE IF EXISTS `dq_statistic_terminal`;
CREATE TABLE `dq_statistic_terminal` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
...
DROP TABLE IF EXISTS `dq_statistic_duration`;
CREATE TABLE `dq_statistic_duration` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `user_id` bigint(20) DEFAULT NULL,
  `email` varchar(255) DEFAULT NULL,
